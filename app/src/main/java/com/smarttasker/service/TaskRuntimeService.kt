...
class TaskRuntimeService : Service() {
    ...
    companion object {
        const val ACTION_START = "com.smarttasker.action.TASK_RUNTIME_START"
        const val ACTION_UPDATE = "com.smarttasker.action.TASK_RUNTIME_UPDATE"
        const val ACTION_STOP = "com.smarttasker.action.TASK_RUNTIME_STOP"
