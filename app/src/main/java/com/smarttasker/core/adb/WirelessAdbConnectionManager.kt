...
/**
 * Embedded wireless ADB connection manager for SmartTasker.
 *
...
class WirelessAdbConnectionManager(
    ...
    override fun getDeviceName(): String {
        ...
        return if (brand.isBlank()) "SmartTasker-$model" else "SmartTasker-$brand-$model"
    }
    ...
    private fun generateAndPersist(keyFile: File, certFile: File) {
        ...
        val name = X500Name("CN=SmartTasker")
